...
probe -create -emptyok -database ams_database {TB_OneCH_Top.Mag_ST[4]}
probe -create -emptyok -database ams_database {TB_OneCH_Top.Mag_ST[3]}
probe -create -emptyok -database ams_database {TB_OneCH_Top.Mag_ST[2]}
probe -create -emptyok -database ams_database {TB_OneCH_Top.Mag_ST[1]}
probe -create -emptyok -database ams_database {TB_OneCH_Top.Mag_ST[0]}
